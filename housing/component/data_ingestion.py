...
class DataIngestion:
    ...
    def download_housing_data(self) -> str: #download data
        try:
            ...
            #complete filepath for download
    ...
    def extract_tgz_file(self, tgz_file_path : str): #Extract data
        try:
    ...
    def split_data_as_train_test(self) -> DataIngestionArtifact: #traintest split
        try:
            raw_data_dir = self.data_ingestion_config.raw_data_dir
